...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2023-10-01T22:28:45.891713" />
 ...
 <div class="container margin">
   ...
   <div class="row">
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6a2"> PGSQL Phriday 013 - Usecases and Why PostgreSQL</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Chris Ellis</li>
              <li><i class="far fa-clock"></i>&nbsp;2023-09-28</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6a7"> pgenv version 1.3.3 released</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6a5"> TIL - When was my Postgres cluster initialized ?</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Kaarel Moppel</li>
              <li><i class="far fa-clock"></i>&nbsp;2023-09-27</li>
            </ul>
          </div>
        </div>
